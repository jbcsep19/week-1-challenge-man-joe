    ...
    public static void main(String[] args){
        ...
        switch (input) {
            ...
            case "k":
                ...
                if(input.equals("1")){
                    ...
                    if(input.equals("y")){
                        ...
                        System.out.println("A Man... or Woman of true intellect! ... A Zombie bites your face off ,as you" +
                        "try to defend yourself with a dull Kife");
                        break;
                    }
                    ...
                    if(input.equals("k")) {
                        ...
                        System.out.println("You feel a great surge of power rising from your inner loins as you plunge the" +
                        " blade into the zombies heart.");
                        System.out.println("........");
                        System.out.println("The zombie shakes his head in disapproval as it lodges it's mouth right unto your neck");
                        System.out.println("Don't do drugs kids. It'll make you forget that zombies can't die from heart attacks");
                        break;
                    } else if(input.equals("p")){
                        System.out.println("Peaceful Slaughter? That's a oxymoron... You kill 5 zombies dressed as Ghandi?");
                ...
                break;
            case "h":
                System.out.println("Nice! You are going bare-handed! How much fighting experience do you have? A lot or none? (a/0)");
                input = sc.next();
                if(input.equals("a")){
                    ...
                    if(input.equals("m")){
                        ...
                        System.out.println("It lays on the ground motionless. Other zombies just shake their head disapprovingly");
                    ...
                    input = sc.next();
                    if(input.equals("l")){
                        System.out.println("Wow. Can you be anymore awesome. 0 experience and your going to fight drunk.");
                        ...
                        System.out.println("This is when you knew, that this everfleeting moment is whats been missing in your life.");
                        System.out.println("With all the emotions of finding your one true purpose in life, you let out a roar that shook the Earth " + 
                        "beneath your feet");
                        System.out.println("...");
            ...
            case "f":
                ...
                input = sc.next();
                if(input.equals("c")){
                    System.out.println("Nice. Its highly durable, hold all kinds of heat, and can last a lifetime if taken care properly");
                    ...
                    if(input.equals("y")) {
                        ...
                        System.out.println("It's also relatively inexpansive compared to other pans and it can boost your iron intake.");
                        ...
                        System.out.println("You killed several zombies and found that cast iron pans are also great at delivering blunt trauma");
                        System.out.println("But you also ruined the pan forever as now the cast iron has zombie seasoning");
                        ...
                        if(input.equals("s")) {
                            ...
                            System.out.println("Well... its not the best solution but hey. Zombie seasoning might be good.");
                            System.out.println("In fact, since its on a cast iron you might not die.");
                            System.out.println("...");
                            System.out.println("Eating from the cast iron with zombie seasoning has given you everlasting life.");
                            break;
                        }
                    }
                } else if(input.equals("s")) {
                    System.out.println("Stainless steel. I see you are a person who likes shiny things");
                    System.out.println("Okay, Do you throw it away and look for a cast iron or Us it? (t/u)");
                    input = sc.next();
                    if(input.equals("t")){
